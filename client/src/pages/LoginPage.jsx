...
export default function LoginPage() {
  ...
  // Redirect to dashboard or where the user was heading before login
    ...
    <div className="flex-grow flex items-center justify-center py-16 px-4 relative bg-navy-950">
      ...
      <div className="w-full max-w-md glass-panel rounded-2xl p-8 border border-slate-900 shadow-2xl relative z-10 animate-fade-in">
        <div className="text-center mb-8">
          <h2 className="font-outfit text-3xl font-extrabold text-white mb-2">Welcome Back</h2>
          <p className="text-slate-400 text-sm">Sign in to manage and view your saved itineraries.</p>
        </div>
        ...
        <div className="mt-8 text-center text-sm text-slate-400">
          ...
          <Link to="/register" className="text-brand-400 hover:text-brand-300 font-semibold inline-flex items-center gap-0.5">
            <span>Sign Up</span>
